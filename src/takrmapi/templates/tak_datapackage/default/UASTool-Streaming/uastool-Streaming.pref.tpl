...
<preferences>
  <preference version='1' name='com.atakmap.app_preferences'>
    ...
    <entry key="uastool.pref_cached_network_endpoints" class="class java.util.HashSet"><element>{{ v.mmtx_server_public_address }}</element></entry>
    ...
    <entry key="uastool.pref_video_observer_url" class="class java.lang.String">{{ v.mmtx_server_observer_proto }}://{{ v.mmtx_server_public_address }}:{{ v.mmtx_server_observer_port }}/live/uas/{{ v.client_cert_name }}{% if v.mmtx_server_observer_net_proto == 'tcp' %}?tcp{% endif %}</entry>
