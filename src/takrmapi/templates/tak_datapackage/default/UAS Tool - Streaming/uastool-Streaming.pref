...
<preferences>
  <preference version='1' name='com.atakmap.app_preferences'>
    ...
    <entry key="uastool.pref_cached_network_endpoints" class="class java.util.HashSet"><element>{{ tak_server_name }}</element></entry>
    <entry key="uastool.pref_callsign" class="class java.lang.String">UAS-{{ client_cert_name }}</entry>
    ...
    <entry key="uastool.pref_video_observer_url" class="class java.lang.String">rtsps://{{ tak_server_name }}:8322/live/uas/{{ client_cert_name }}?tcp</entry>
    <entry key="uastool.pref_srt_dest_host" class="class java.lang.String">{{ tak_server_name }}</entry>
    <entry key="uastool.pref_srt_dest_port" class="class java.lang.String">8890</entry>
    <entry key="uastool.pref_srt_stream_id" class="class java.lang.String">publish:live/uas/{{ client_cert_name }}:USERNAME:PASSWORD</entry>
