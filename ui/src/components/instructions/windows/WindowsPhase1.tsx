            ...
            <AccordionContent>
              <CardContent className="p-2 space-y-4 text-sm">
                <div className="pl-4 space-y-2">
                  <p className="font-medium">{t("tabs.windows.phase1.step1_desc_1")}</p>
                  <img src="/ui/tak/wintak/Kuva1.png" width="400px" alt={t("tabs.windows.phase1.step1_title")} />
                  <p>{t("tabs.windows.phase1.step1_desc_2")}</p>
                  <img src="/ui/tak/wintak/Kuva2.png" width="400px" alt={t("tabs.windows.phase1.step1_desc_2")} />
                  <p>{t("tabs.windows.phase1.step1_desc_3")}</p>
                  <img src="/ui/tak/wintak/Kuva3.png" width="400px" alt={t("tabs.windows.phase1.step1_desc_3")} />
        ...
        <AccordionItem value="step2">
          <Card className="p-2">
            ...
            <AccordionContent>
              <CardContent className="p-2 space-y-4 text-sm">
                <div className="pl-4 space-y-2">
                  <img src="/ui/tak/wintak/Kuva4.png" width="400px" alt={t("tabs.windows.phase1.step2_title")} />
                  <p>{t("tabs.windows.phase1.step2_desc_1")}</p>
                  <img src="/ui/tak/wintak/Kuva5.png" width="400px" alt={t("tabs.windows.phase1.step2_desc_2")} />
                  <p>{t("tabs.windows.phase1.step2_desc_2")}</p>
                  <img src="/ui/tak/wintak/Kuva8.png" width="400px" alt={t("tabs.windows.phase1.step2_desc_3")} />
            ...
            <AccordionContent>
              <CardContent className="p-2 space-y-4 text-sm">
                <div className="pl-4 space-y-2">
                  ...
                  <img src="/ui/tak/wintak/Kuva6.png" width="400px" alt={t("tabs.windows.phase1.step3_desc_1")} />
                  <p>{t("tabs.windows.phase1.step3_desc_2")}</p>
                  <img src="/ui/tak/wintak/Kuva7.png" width="400px" alt={t("tabs.windows.phase1.step3_desc_2")} />
                  <p>{t("tabs.windows.phase1.step3_desc_3")}</p>
                  <img src="/ui/tak/wintak/Kuva8.png" width="400px" alt={t("tabs.windows.phase1.step3_desc_3")} />
